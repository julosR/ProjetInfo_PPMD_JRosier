...
<qgis labelsEnabled="0" version="3.22.16-Białowieża" styleCategories="Symbology|Symbology3D|Labeling|Fields|Forms|Actions|AttributeTable">
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" force_rhr="0" name="0">
        ...
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" value="255,0,0,101" name="color"/>
